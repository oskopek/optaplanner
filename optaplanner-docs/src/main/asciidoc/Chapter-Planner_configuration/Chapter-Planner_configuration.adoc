...
public class Visit ... implements Standstill {
    ...
    public void setPreviousStandstill(Standstill prevAction) {
...
* The value range provider that holds the initialized planning entities, for example ``actionList``.
...
public class Standstill {
    ...
    @InverseRelationShadowVariable(sourceVariableName = "prevAction")
...
public class Customer {
    ...
    @AnchorShadowVariable(sourceVariableName = "prevAction")
...
----
    ...
    @CustomShadowVariable(variableListenerClass = VehicleUpdatingVariableListener.class,
            sources = {@PlanningVariableReference(variableName = "prevAction")})
    public Vehicle getVehicle() {
        return vehicle;
    }
----
...
public class VehicleUpdatingVariableListener implements VariableListener<Customer> {
    ...
    protected void updateVehicle(ScoreDirector scoreDirector, Customer sourceCustomer) {
        Standstill prevAction = sourceCustomer.getPreviousStandstill();
        Vehicle vehicle = prevAction == null ? null : prevAction.getVehicle();
