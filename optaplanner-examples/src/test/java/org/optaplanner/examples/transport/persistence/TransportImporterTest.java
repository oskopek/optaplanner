...
public class TransportImporterTest extends SolutionImporterTest {

    @Override
    protected AbstractSolutionImporter createSolutionImporter() {
        return new TransportImporter();
    }

    @Parameterized.Parameters(name = "{index}: {0}")
    public static Collection<Object[]> getInputFilesAsParameters() {
        return getInputFilesAsParameters(new TransportImporter());
    }

    public TransportImporterTest(File solutionFile) {
        super(solutionFile);
    }
